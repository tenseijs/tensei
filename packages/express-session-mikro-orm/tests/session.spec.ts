        ...
        orm.em
          ...
          .then(() => {
            ...
            store.get(1, (error: any, value: any) => {
              ...
              expect(value.cookie.originalMaxAge).to.eq(2592000000)
      ...
      .then(() =>
        orm.em
          ...
          .then(() => {
            ...
            store.set(3, updatedSession, (error: any, value: any) => {
              expect(error).to.be.null

              expect(value.session_id).to.eq(3)
              const parsedSession = JSON.parse(value.data)
              expect(parsedSession.user).to.eq(updatedSession.user)
                ...
                (error: any, value: any) => {
                  ...
                  orm.em
                    ...
                    .then((foundSession: any) => {
                      expect(foundSession.expires.toDateString()).to.eq(
