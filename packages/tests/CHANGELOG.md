...
* Remove \_\_\_refresh_tokens method and send refresh token in response body
...
- **auth:** Token in body response is now accessToken, and a new refresh_token is included in
  response
