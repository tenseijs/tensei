            ...
            >
                {onCheckboxChange && (
                    <Checkbox
                        checked={checked}
                        onChange={(event) => {
                            // Leave empty and rely on button evet.
                        }}
                        className="media-absolute media-top-0 media-left-0 media-mt-5 media-ml-5 media-z-30"
                    />
                )}
                {isImage(file) ? (
                        <img
                            src={getFullAssetPath(file)}
                            className="media-max-w-full media-max-h-full media-w-full media-w-auto media-h-auto media-m-auto"
