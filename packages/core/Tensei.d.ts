declare module '@tensei/core' {
    ...
    import { PluginContract, ResourceContract, SetupFunctions, Manager, SupportedDatabases, PluginSetupConfig } from '@tensei/common';
    ...
    export interface TenseiContract {
        ...
        authMiddleware: (request: Express.Request, response: Express.Response, next: Express.NextFunction) => Promise<Express.Response<any> | undefined>;
        setAuthMiddleware: (request: Express.Request, response: Express.Response, next: Express.NextFunction) => Promise<void | Express.Response<any>>;
        registerCoreRoutes(): void;
        registerAssetsRoutes(): void;
        asyncHandler(handler: Express.Handler): Express.RequestHandler<import("express-serve-static-core").ParamsDictionary, any, any, import("qs").ParsedQs>;
